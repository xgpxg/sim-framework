    ...
    <el-row :gutter="20">
      <el-col :span="24">
        <div class="toolbar">
          ...
          <el-divider direction="vertical"></el-divider>
          <span class="bar-text" style="color: red">未选择数据源</span>
          <el-divider direction="vertical"></el-divider>
          <el-dropdown size="small" @command="command">
            <el-button type="text" style="color: grey">
              选择数据源<i class="el-icon-arrow-down el-icon--right"></i>
            </el-button>
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item :command="'12313'">Mysql库</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
          <el-divider direction="vertical"></el-divider>
          <el-button type="" icon="el-icon-plus" size=""
                     class="btn" style="color: grey" title=""
                     @click="">保存为片段
          </el-button>
